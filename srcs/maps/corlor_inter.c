...
/*   Updated: 2025/10/28 19:27:33 by waragwon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_get_color(t_point_2d cur, t_point_2d a, t_point_2d b)
{
	...
	red = interpolate_chanel(get_channel(a.rgba, 24), get_channel(b.rgba, 24), percent);
	green = interpolate_chanel(get_channel(a.rgba, 16), get_channel(b.rgba, 16), percent);
	blue = interpolate_chanel(get_channel(a.rgba, 8), get_channel(b.rgba, 8), percent);
